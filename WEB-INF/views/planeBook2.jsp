...
$(document).ready(function() {
	...
	var text2 = (${planeBook2.total} + 30000);
	...
	$(".notChoice").click(function() {
		...
		$('.lastP').text(${planeBook2.total} + '원');
		$('.price').text(${planeBook2.total});
		$('#total').attr('value', ${planeBook2.total});
	})
				...
				<div class="ly_wrap pay_info">
					<div class="inr">
						<div class="cont_unit">
							...
							<input type="hidden" name="ticketNo"  value="${planeBook2.ticketNo}">
							<input type="hidden" name="ticketSt"  value="${planeBook2.ticketSt}">
							<input type="hidden" name="ticketSp"  value="${planeBook2.ticketSp}">
							<input type="hidden" name="stDate"  value="${planeBook2.stDate}">
							<input type="hidden" name="spDate"  value="${planeBook2.spDate}">
							<input type="hidden" name="people"  value="${planeBook2.people}">
							<input type="hidden" name="total" value="${planeBook2.total}">
							<input type="hidden" name="id"  value="${planeBook2.id}">
							<input type="hidden" name="planeBookNo"  value="${planeBook2.planeBookNo}">
							<input type="hidden" name="stm" value="${planeBook2.stm}">
							<input type="hidden" name="sth"  value="${planeBook2.sth}">
							<input type="hidden" name="spm"  value="${planeBook2.spm}">
							<input type="hidden" name="sph"  value="${planeBook2.sph}">
						...
						<div class="js_acc multi filter_wrap">
							<div class="pay_area">
								<div class="info_area total">
									...
									<strong class="price">${planeBook2.total}<span>원</span></strong>
								...
								<div class="info_area">
									<div class="info">
										<strong class="tit">총 상품금액</strong> <span class="lastP">${planeBook2.total}원</span>
									</div>
								</div>
								<!---->
								<!---->
