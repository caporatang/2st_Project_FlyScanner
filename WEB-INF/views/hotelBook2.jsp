<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	String eFirth = request.getParameter("eFirth");
...
/* 
	System.out.print(hName + "@hName@@@@");
	System.out.print(kName + "@kkkkkName!!!!!!!!@@@");
	System.out.print(hName + "@hName@@@@");
	System.out.print(hRegion + "@@region@@@");
	System.out.print(total + " : 총액@@@@@");
...
$(document).ready(function() {
	...
	$('a[href="hotelPay.do"]').click(function(e){
						...
						<div class="js_acc multi filter_wrap">
							<div class="pay_area">
								<div class="info_area total">
									...
									<strong class="price mt5" > <%= total %> <span>원</span></strong>
								...
								<div class="info_area">
									<div class="info">
										<strong class="tit">결제할 금액</strong> <span class="lastP"><%= total %>원</span>
									</div>
								</div>
							</div>
						</div>
						<form action = "hotelPay.do">
						<div class="btn_wrap">
							<button class="btn big pink full"><span class="lastP"><%= total %>원</span> 결제하기</button>
							...
							<input type="hidden" name="coupon"  value="${hotel2.coupon}">
							<input type="hidden" name="hotelBookNo"  value="<%= hotelBookNo %>"> 
							<input type="hidden" name="kName"  value="<%= kName %>"> 
							<input type="hidden" name="eFirth"  value="<%= eFirth %>"> 
							<input type="hidden" name="eLast"  value="<%= eLast %>"> 
